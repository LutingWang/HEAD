...
pai -name pytorch180
    ...
    -DworkerCount=${GPUS}
    -DuserDefinedParameters=\"${CONFIG} --cfg-options checkpoint_config.create_symlink=False evaluation.tmpdir=work_dirs/tmp${RANDOM} --no-log-file --work-dir work_dirs/${JOB_NAME} --launcher pytorch ${PY_ARGS}\"
